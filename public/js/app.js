    ...
    if (/AppleWebKit/.test(user_agent)) {
        if (/iPhone/.test(user_agent) || /iPad/.test(user_agent)) {
            if (window.matchMedia("(orientation: portrait)").matches) {
                ...
                }, _defineProperty(_$$css, 'height', '-o-calc(100vh - ' + height + 'px)'), _defineProperty(_$$css, 'height', 'calc(100vh - ' + height + 'px)'), _$$css));
            } else {
                var _$$css2;

                $('#main_site').css((_$$css2 = {
                    'height': '-webkit-calc(100vh - 50px)'
                }, _defineProperty(_$$css2, 'height', '-o-calc(100vh - 50px)'), _defineProperty(_$$css2, 'height', 'calc(100vh - 50px)'), _$$css2));
            }
        } else if (/Android/.test(user_agent)) {
            var _$$css3;

            $('#main_site').css((_$$css3 = {
                'height': '-webkit-calc(100vh - 60px)'
            }, _defineProperty(_$$css3, 'height', '-o-calc(100vh - 60px)'), _defineProperty(_$$css3, 'height', 'calc(100vh - 60px)'), _$$css3));
        }
    }
